...
public:
	...
	//anadido physics manager como parametro
    void parseDotScene(const Ogre::String &SceneName, const Ogre::String &groupName,
		Ogre::SceneManager *yourSceneMgr, PhysicsManager* physicsMgr = 0, Ogre::SceneNode *pAttachNode = NULL, 
...
protected:
	...
	void processPhysics(rapidxml::xml_node<>* XMLNode, Ogre::SceneNode *pNode = 0);
	////////////////////////////////////////////////////
	////////////////////////////////////////////////////
	//modificando para anadir soporte para animaciones
	void processAnimation(rapidxml::xml_node<>* XMLNode, Ogre::SceneNode *pNode = 0);
	////////////////////////////////////////////////////
